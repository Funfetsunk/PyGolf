...
def get_available_sponsors(tour_level: int) -> list[dict]:
    """Return sponsors available for the given tour level."""
    return [s for s in SPONSORS if s["min_tour"] <= tour_level]
